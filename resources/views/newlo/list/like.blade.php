<x-layout title="TOP | NewLo">
    ...
    <x-slot name="header">
        <div class="mx-auto max-w-7xl py-6 pl-6 px-4 sm:px-6 lg:px-8">
            ...
            <h2 class="text-1xl font-bold tracking-tight text-gray-600 pl-8">いいね一覧</h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
            <div>
                ...
                <div class="mb-10 md:mb-16 text-right">
                    <p class="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">これまでいいねを押した投稿の一覧です。</p>
                </div>

                <x-event.list.like :events="$events" :ages="$ages" :prefectures="$prefectures" :categories="$categories" :like="$like"></x-event.list.like>
