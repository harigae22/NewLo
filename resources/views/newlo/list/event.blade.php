<x-layout title="TOP | NewLo">
    ...
    <x-slot name="header">
        <div class="mx-auto max-w-7xl py-6 pl-6 px-4 sm:px-6 lg:px-8">
            ...
            <h2 class="text-1xl font-bold tracking-tight text-gray-600 pl-8">みんなのイベント一覧</h2>
        </div>
    </x-slot>

    <div class="fixed top-24 right-4 h-16 w-16 Z-50">
            ...
            <div>
                <div class="mb-10 md:mb-16 text-right">
                    <p class="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">
                        あなたに合った素敵な旅行内容が見つかるかも!<br>
                        ここでは、これまで投稿されたイベントの検索を行えます。<br>
                        ぜひ、実際に体験したいイベントを見つけよう！
                    </p>
                </div>

                <x-event.form.search :ages="$ages" :prefectures="$prefectures" :categories="$categories"></x-event.form.search>
                
                <x-event.list.event :events="$events" :ages="$ages" :prefectures="$prefectures" :categories="$categories" :like="$like"></x-event.list.event>
