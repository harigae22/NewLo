<x-layout title="NewLo">
    ...
    <section class="overflow-hidden text-neutral-700 relative">
        ...
        <div
            class="flex shadow-[0_4px_9px_-4px_#3b71ca] justify-center space-x-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black z-40">
