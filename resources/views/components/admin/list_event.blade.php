        ...
        <div class="max-w-screen-2xl mx-auto">
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 md:gap-x-6 gap-y-6">
                @foreach ( $events as $event)
                    <div>
                        <div class="ioverflow-hidden  aspect-video bg-red-400 cursor-ponter rounded-xl relative group">
                            <a href="{{route('admin.show.index', ['eventId' => $event->id])}}" class="object-cover w-full aspect-square group-hover:scale-110 transition duration-300 ease-in-out h-60 group h-50 block bg-gray-100 rounded-lg overflow-hidden shadow-lg mb-2 lg:mb-3">
                        ...
                        <div class="flex flex-col">
                            <div class="flex justify-between">
                                ...
                                <form action="{{route('newlo.event_list.like')}}" method="post">
                                    @csrf
