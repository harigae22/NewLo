            ...
            @foreach ( $events as $event)
                <div>
                    <div class="ioverflow-hidden cursor-ponter rounded-xl relative group">
                        <a href="{{route('newlo.show',['eventId' => $event->id])}}" class="object-cover w-full aspect-square group-hover:scale-110 transition duration-300 ease-in-out h-60 group h-50 block bg-gray-100 rounded-lg overflow-hidden shadow-lg mb-2 lg:mb-3">
