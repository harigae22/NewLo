            ...
            @foreach ( $events as $event)
                <div>
                    <div class="ioverflow-hidden  aspect-video cursor-ponter rounded-xl relative group">
                        <a href="{{route('newlo.my_show', ['eventId' => $event->id])}}" class="object-cover w-full aspect-square group-hover:scale-110 transition duration-300 ease-in-out h-60 group h-50 block bg-gray-100 rounded-lg overflow-hidden shadow-lg mb-2 lg:mb-3">
                    ...
                    <div class="flex flex-col">
                        <div class="flex justify-between">
                            ...
                            <div class="flex">
                                <x-element.button_like_count :event="$event" :like="$like"></x-element.button_like_count>
                                
                                <x-element.details :event='$event'></x-element.details>
                            </div>
                        </div>
